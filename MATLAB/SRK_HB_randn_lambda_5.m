...
for repeat = 1:num_repeats
    ...
    for iter = 1:maxiter
        ...
        % sparse Kaczmarz with relaxed exact ('double inexact') momentum 
            tic
...
if writeout
    ...
    './randn_sparse/lambda=5/res_over_iter_means.txt',...
    ...
    mean_res_hb(:, 6), mean_res_hb(:, 7), mean_res_hb(:, 8), mean_res_hb(:, 9), mean_res_hb(:,10)]) 

    writeout_data_over_array_on_xaxis(...
        './randn_sparse/lambda=5/res_over_iter_quantiles.txt',...
